...
export async function initializeScene(scene, renderer) {
    ...
    const hdrDay = new URL('../Art/Textures/scythian_tombs_2_4k.hdr', import.meta.url);
    const hdrNight = new URL('../Art/Textures/moonless_golf_4k.hdr', import.meta.url);

    try {
        hdrTexture = await loadEnvironment(hdrNight); //Change between day and night
